    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col h-auto relative">
          {/* Top side - Image container for mobile and tablet */}
          <div className="w-full mb-8 sm:mb-12 md:mb-16 flex items-center justify-center">
            <motion.div 
              className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg aspect-[4/3] rounded-xl overflow-hidden shadow-2xl mx-auto"
              animate={{
          ...
          {/* Bottom side - Scrollable content */}
          <div 
            ref={containerRef}
            className="w-full overflow-y-auto px-4 sm:px-6 lg:px-8 hide-scrollbar"
          ...
          <div className="hidden lg:flex lg:flex-row lg:space-x-8 lg:mt-8">
            <div className="lg:w-1/2 lg:sticky lg:top-24 self-start lg:h-[500px] flex items-center justify-center">
              <motion.div 
                className="relative w-full max-w-lg aspect-[4/3] rounded-xl overflow-hidden shadow-2xl"
                animate={{
                  boxShadow: `0 25px 50px -12px ${backgroundColors[activeStep].replace('bg-', 'rgba(var(--')}-500, 0.25)`
                }}
                transition={{ duration: 0.7 }}
